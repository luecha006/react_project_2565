        ...
        try {
          ...
          querySnapshot.forEach((doc) => {
            if (doc.data().cactusFamily === "Gymnocalycium") {
              ...
              setDataToshowTable((dataToshowTable) => [
                ...dataToshowTable,
                data,
              ]);
      ...
      >
        <div className="container">
                        ...
                        <Row>
                          ...
                          <Col>
                            <div className="nameOf">
                              <h2>
                                ชื่อวิทยาศาสตร์ : <span>{scientificName}</span>
                              </h2>
                              <h4>
                                ชื่อสามัญ : <span>{commonName}</span>
                              </h4>
                              <h4>
                                ชื่ออื่นๆ : <span>{otherNames}</span>
                              </h4>
                              <h4>
                                วงศ์ : <span>{family}</span>
                              </h4>
                            </div>
                          </Col>
                        </Row>
          ...
          <div className="row mb5">
            ...
            <div
              className="table-responsive border p-4 bg-light rounded"
                  ...
                  {dataToshowTable.map((cactus) => {
                    return (
                      <tr key={cactus.id}>
                        ...
                        <td>
                          <h5 className="info-td">{cactus.name}</h5>
                        </td>
                        <td>
                          <h5 className="info-td">{cactus.cactusFamily}</h5>
                        </td>
                        <td>
                          <button
                            onClick={() => {
